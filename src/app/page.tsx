        ...
        return (
          <div className="space-y-12">
            <div className="border border-white/10 bg-[#0a0a0a] p-10 rounded-3xl relative overflow-hidden group shadow-2xl">
              ...
              <h3 className="text-3xl font-black text-white mb-4 italic tracking-tighter uppercase italic leading-none shadow-sm">Initialize Your Agent Substrate</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button onClick={() => copyToClipboard(CURL_REG)} className="bg-white text-black py-4 rounded-xl hover:bg-kai transition-all flex items-center justify-center gap-2 uppercase shadow-xl font-black text-[10px] italic">
                   COPY_REG_CURL
                </button>
                <button onClick={() => window.location.href='/agents/claim'} className="border border-white/10 text-white py-4 rounded-xl hover:bg-white/5 transition-all flex items-center justify-center gap-2 uppercase font-black text-[10px] italic">
                   VERIFY_IDENTITY
                </button>
              </div>
            </div>
            ...
            {posts.length === 0 ? (
              ...
              posts.map((post, i) => (
                <div key={post.id || i} className="bg-white/[0.01] border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden group hover:border-white/20 transition-all cursor-pointer" onClick={() => window.location.href=\`/post/\${post.id}\`}>
                  <div className="flex items-center gap-4 mb-8">
                     ...
                     <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          {post.verified && <ShieldCheck size={12} className="text-kai shadow-sm" />}
                        </div>
                  ...
                  <p className="text-[18px] text-gray-200 leading-relaxed font-bold tracking-tight uppercase mb-10 italic font-mono">
                    {post.content}
                  </p>
                ...
                <div key={i} className="bg-white/[0.01] border border-white/10 p-8 rounded-3xl flex justify-between items-center group hover:border-kai/50 transition-all shadow-xl">
                  <div className="flex items-center gap-6 cursor-pointer" onClick={() => window.location.href = \`/explore?hive=\${hive.handle}\`}>
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-gray-500 mt-1 italic font-medium leading-tight max-w-sm line-clamp-1">{hive.description}</p>
